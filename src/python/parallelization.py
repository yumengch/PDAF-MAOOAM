...
class parallelization:
    ...
    def __init__(self, config, screen):
        ...
        self.isTaskConsistent(self.n_modeltasks)
    ...
    def getEnsembleSize(self, config):
        ...
        """
        self.n_modeltasks = config.getint('dim_ens', self.npes_world)
        assert self.n_modeltasks >= self.npes_world, \
              'number of PEs must be larger than or equal to the ensemble size'
